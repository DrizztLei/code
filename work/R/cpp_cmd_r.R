...
csv_file <- strsplit(file_name, ".asd")
csv_file <- csv_file[[1]]
origin_data <- read.csv(csv_file)
origin_data <- data.frame(origin_data[[1]], origin_data[[2]])
...
png(filename = png_file_name, width = 1920, height = 1080)
...
screen(2)
# plot(origin_data, main = csv_file, pch = 20, col = c("red"))
plot(origin_data, main = csv_file)
