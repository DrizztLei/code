    ...
    ui(new Ui::AddProprietorWidget)
{
    ...
    QString sqlBuilding = "select building_id from building";
    qDebug() << "SQL";

    bool result = query.exec(sqlBuilding);
    qDebug() << result;
    ...
    sqlBuilding = "select id,name,building_id, room_id,own_date from proprietor";

    query.exec(sqlBuilding);
