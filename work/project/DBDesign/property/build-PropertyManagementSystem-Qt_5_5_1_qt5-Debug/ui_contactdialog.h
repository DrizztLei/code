...
public:
    ...
    void retranslateUi(QDialog *ContactDialog)
    {
        ...
        label->setText(QApplication::translate("ContactDialog", "Developer", 0));
        label_2->setText(QApplication::translate("ContactDialog", "Elvis Lei", 0));
        label_3->setText(QApplication::translate("ContactDialog", "elvis.linuxer@gmail.com", 0));
    } // retranslateUi
