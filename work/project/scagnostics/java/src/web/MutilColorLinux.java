...
public class MutilColorLinux
{
	...
	public static final String root = "/home/elvis/DATASET/ADD/OUTPUT/"; // change
																			// root
																			// here
	public static final String path = root + "/Skewed/"; // change
															// father
															// directory
	
	public static final String TxTInfo = path + "/info";
		...
		for (int i = 0; i < feature_number; i++)
		{
			...
			*/
			...
			for (int j = 0; j < varSet.length; j += TYPENUMBER)
			{
				...
				for(int k = 0; k < NUMBER; ++k)
				{
					System.out.print(filename[k + (seq / TYPENUMBER) * NUMBER] + "\t");
				}
				System.out.println();
				*/
				for (int k = 0; k < NUMBER; ++k)
