...
void MainWindow::connect(){
  ...
  invoker->setCommand(list_choose);
  invoker->setCommand(player_to_slider);
  invoker->setCommand(slider_to_player);
  invoker->setCommand(player_to_main);
...
QAction * MainWindow::getPre(){
  return ui->actionPrevious;
}

QAction * MainWindow::getNext(){
