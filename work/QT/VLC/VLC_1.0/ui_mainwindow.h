...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QWidget::setTabOrder(pushButton_3, listWidget);
        QWidget::setTabOrder(listWidget, horizontalSlider);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionClose->setText(QApplication::translate("MainWindow", "&Play", 0));
        actionExit->setText(QApplication::translate("MainWindow", "&Exit", 0));
        actionPrevious->setText(QApplication::translate("MainWindow", "P&revious", 0));
