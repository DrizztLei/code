...
def main(argv=None):
	...
	convolution_weights_1 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, NUM_CHANNEL, 64], seed=SEED,
	                                                                      stddev=0.01, dtype=tf.float32))

	convolution_biases_1 = tf.Variable(initial_value=tf.zeros(shape=[64], dtype=tf.float32))

	convolution_weights2 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 64, 64], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases2 = tf.Variable(initial_value=tf.zeros(shape=[64], dtype=tf.float32))

	convolution_weights3 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 64, 128], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases3 = tf.Variable(initial_value=tf.zeros(shape=[128], dtype=tf.float32))

	convolution_weights4 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 128, 256], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases4 = tf.Variable(initial_value=tf.zeros(shape=[256], dtype=tf.float32))

	convolution_weights5 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 256], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases5 = tf.Variable(initial_value=tf.zeros(shape=[256], dtype=tf.float32))

	convolution_weights6 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 256], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases6 = tf.Variable(initial_value=tf.zeros(shape=[256], dtype=tf.float32))

	convolution_weights7 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 256], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases7 = tf.Variable(initial_value=tf.zeros(shape=[256], dtype=tf.float32))

	convolution_weights8 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 256], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases8 = tf.Variable(initial_value=tf.zeros(shape=[256], dtype=tf.float32))

	convolution_weights9 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 512], seed=SEED,
	                                                                     stddev=0.01, dtype=tf.float32))

	convolution_biases9 = tf.Variable(initial_value=tf.zeros(shape=[512], dtype=tf.float32))

	convolution_weights10 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 512], seed=SEED,
	                                                                      stddev=0.01, dtype=tf.float32))

	convolution_biases10 = tf.Variable(initial_value=tf.zeros(shape=[512], dtype=tf.float32))

	convolution_weights11 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 512], seed=SEED,
	                                                                      stddev=0.01, dtype=tf.float32))

	convolution_biases11 = tf.Variable(initial_value=tf.zeros(shape=[512], dtype=tf.float32))

	convolution_weights12 = tf.Variable(initial_value=tf.truncated_normal(shape=[3, 3, 256, 512], seed=SEED,
	                                                                      stddev=0.01, dtype=tf.float32))

	convolution_biases12 = tf.Variable(initial_value=tf.zeros(shape=[512], dtype=tf.float32))
	...
	fc3_weights = tf.Variable(
		initial_value=tf.truncated_normal(shape=[4096, 5], stddev=0.01, seed=SEED, dtype=tf.float32))
