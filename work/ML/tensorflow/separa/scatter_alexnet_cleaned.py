...
FILENAME = "/home/elvis/work/ML/tensorflow/separa/cleaned_data_1.csv"
...
def main(argv=None):
    ...
    data, label, fileset = parse_cleaned_data(SIZE=SIZE, IMAGE_SIZE=IMAGE_SIZE, NUM_CHANNEL=NUM_CHANNEL, LABEL=LABEL,
                                              BASE_DIVIDE=BASE_DIVIDE, FILENAME=FILENAME)
