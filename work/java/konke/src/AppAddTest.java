...
public class AppAddTest {
	...
	private static final String ADD_URL = "http://kk.bigk2.com:8080/KOAuthDemeter/User/queryUserId";
	...
	public static void appadd() throws IOException {
		...
		// "elvis.linuxer@gmail.com");
		// 将token放到头部
		connection.setRequestProperty("Authorization", "Bearer " + token);
		//connection.setRequestProperty("username", "elvis.linuxer@gmail.com");
		connection.connect();
		
		RequestParamsBean params = new RequestParamsBean();
		params.setUserid("elvis.linuxer@gmail.com");
		params.setUsername("elvis.linuxer@gmail.com");
		//params.setUsername("elvis.linuxer@gmail.com");
