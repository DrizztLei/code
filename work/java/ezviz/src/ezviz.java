...
public class ezviz 
{
	...
	private final static String kid = "d9b6073f-e334-49a6-af5c-e1b6e8516ae9";// Optional 
			...
			if(flag != '0')
			{
				if(result.indexOf("invalid_token") != -1)
				{
					try
					{
						...
						return post(index, info);
					}
					catch (StackOverflowError e) 
					{
						// TODO: handle exception
						getPrintErr().print("Error for access token invalid . Pleas check your id and secret");
						getPrintErr().flush();
						System.exit(-1);
					}
					catch (Exception e) {
