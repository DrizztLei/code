...
public class EdgeSc
{
	...
	protected EdgeSc invE = null; // inverse edge (p2->p1)
	protected EdgeSc nextE = null; // next edge in the triangle in
									// counterclockwise
	protected EdgeSc nextH = null; // convex hull link
	...
	protected EdgeSc(Node p1, Node p2)
	{
		update(p1, p2);
	}
	...
	protected EdgeSc makeSymm()
	{
		EdgeSc e = new EdgeSc(p2, p1);
		linkSymm(e);
		return e;
	}

	protected void linkSymm(EdgeSc e)
	{
		this.invE = e;
		if (e != null)
		{
	...
	{
		Iterator<EdgeSc> it = n.getNeighborIterator();
		while (it.hasNext())
		{
			EdgeSc e2 = (EdgeSc) it.next();
